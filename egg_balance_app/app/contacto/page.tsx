...
export default function Contacto() {
  return (
    <>
      ...
      <main className="min-h-screen bg-fond overflow-hidden">
        ...
        <section className="relative py-24">
          ...
          <div className="absolute -top-28 -left-20 w-96 h-96 bg-green/20 rounded-full blur-3xl"></div>

          <div className="absolute top-10 right-0 w-80 h-80 bg-yellow/20 rounded-full blur-3xl"></div>

          <div className="max-w-7xl mx-auto px-6 text-center relative z-10">

            <span className="inline-block px-6 py-2 rounded-full bg-white shadow text-green-1-navbar font-semibold">
              EggBalanceAPP
            </span>
        ...
        <section className="max-w-7xl mx-auto px-6 -mt-10 relative z-20">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-3 hover:shadow-2xl transition-all duration-300 border border-border">
              ...
              <div className="w-20 h-20 rounded-full bg-green-1-navbar text-white flex items-center justify-center text-4xl mx-auto">
                📍
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-3 hover:shadow-2xl transition-all duration-300 border border-border">
              ...
              <div className="w-20 h-20 rounded-full bg-yellow text-title flex items-center justify-center text-4xl mx-auto">
                📞
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-xl p-8 text-center hover:-translate-y-3 hover:shadow-2xl transition-all duration-300 border border-border">
              ...
              <div className="w-20 h-20 rounded-full bg-green text-white flex items-center justify-center text-4xl mx-auto">
                ✉️
              </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-white rounded-[32px] shadow-2xl p-10 border border-border">
              ...
              <span className="inline-block px-4 py-2 rounded-full bg-green/10 text-green-1-navbar font-semibold">
                Escríbenos
              </span>
              ...
              <form className="mt-10 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-fond border border-border rounded-2xl p-4 outline-none focus:ring-2 focus:ring-green-1-navbar transition"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-fond border border-border rounded-2xl p-4 resize-none outline-none focus:ring-2 focus:ring-green-1-navbar transition"
                  />
                </div>

                <button
                  className="w-full py-4 rounded-2xl bg-gradient-to-r from-green-1-navbar to-green-2-navbar text-white text-lg font-semibold shadow-xl hover:scale-[1.02] transition-all"
                >
                  Enviar mensaje
                </button>
...
<section className="max-w-5xl mx-auto pb-16">
    ...
    <div className="grid md:grid-cols-3 gap-5">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-md border border-border hover:-translate-y-1 hover:shadow-xl transition">
            ...
            <div className="w-12 h-12 rounded-xl bg-yellow/20 flex items-center justify-center text-2xl">
                🔒
            </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-md border border-border hover:-translate-y-1 hover:shadow-xl transition">
            ...
            <div className="w-12 h-12 rounded-xl bg-green/20 flex items-center justify-center text-2xl">
                🥚
            </div>
        ...
        <section className="pb-12">
          ...
          <div className="flex justify-center">
            ...
            <button className="bg-green-1-navbar hover:bg-green-2-navbar text-white px-8 py-3 rounded-full shadow-lg transition hover:scale-105">
