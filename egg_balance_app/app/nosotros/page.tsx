...
export default function Nosotros() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen px-6 md:px-16 lg:px-24 xl:px-32 py-20 bg-gradient-to-b from-[#EFF5F1] via-[#F2F5F3] to-[#E9F0EB]">

        {/* ENCABEZADO */}
        <div className="text-center mb-12">

          <span className="inline-block px-5 py-2 rounded-full bg-green-1-navbar text-white text-sm font-semibold shadow-xs">
            EggBalanceAPP
          </span>
        ...
        <div className="max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {team.map((member, index) => (
            ...
            <div
              ...
              className="relative overflow-hidden rounded-3xl p-px bg-green-2-navbar shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer"
            >
              ...
              <div className="relative z-10 bg-white rounded-[23px] p-8 text-center border border-white/50">

                {/* FOTO */}
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-32 h-32 rounded-full mx-auto object-cover border-4 border-[#EFF5F1] shadow-md"
                />
        ...
        <div className="max-w-5xl mx-auto mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <div className="bg-white rounded-2xl px-5 py-3 border border-border shadow-xs flex items-center gap-2">
              <Code2 className="w-5 h-5 text-green-1-navbar" />
              <span className="font-semibold text-title">Next.js</span>
            </div>

            <div className="bg-white rounded-2xl px-5 py-3 border border-border shadow-xs flex items-center gap-2">
              <Code2 className="w-5 h-5 text-green-1-navbar" />
              <span className="font-semibold text-title">Node.js</span>
            </div>

            <div className="bg-white rounded-2xl px-5 py-3 border border-border shadow-xs flex items-center gap-2">
              <Database className="w-5 h-5 text-yellow" />
              <span className="font-semibold text-title">MySQL</span>
            </div>

            <div className="bg-white rounded-2xl px-5 py-3 border border-border shadow-xs flex items-center gap-2">
              <BarChart3 className="w-5 h-5 text-green" />
              <span className="font-semibold text-title">Tailwind CSS</span>
            </div>
